            ...
            <div class="d-flex">
                <div>
                    ...
                    <div class="participants mt-2"> 
                        ...
                        <v-tooltip class="image-container" location="top" :text="participant.name" v-for="(participant, index) in item.participants.slice(0, 5)" :key="index">
                            <template v-slot:activator="{ props }">
                                <v-avatar :image="participant.img" v-bind="props"></v-avatar>
                            </template>
                        </v-tooltip>
